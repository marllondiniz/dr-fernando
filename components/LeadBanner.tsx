        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            <Button
              ...
              size="sm"
              variant="secondary"
              className="bg-white text-primary hover:bg-gray-100 hover:shadow-lg hover:shadow-white/25"
            >
            ...
            <button
              ...
              className="text-white hover:text-gray-200 hover:bg-white/10 rounded-full p-1 transition-all duration-200 hover:scale-110"
            >
              <X className="h-4 w-4" />
            </button>
          </div>
