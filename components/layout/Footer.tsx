      ...
      <div className="mx-auto max-w-7xl px-6 py-20 lg:px-8">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-4">
          ...
          <div className="lg:col-span-1">
            <h3 className="text-2xl font-bold text-primary mb-4">Dr. Fernando Del Piero</h3>
          ...
          <div>
            ...
            <div className="space-y-3">
              <Button asChild variant="outline" size="sm" className="w-full border-peach-300 text-peach-400 hover:bg-peach-300 hover:text-white">
              ...
              {socialLinks.map((link) => {
                ...
                return (
                  <Link
                    ...
                    className={`text-gray-300 hover:text-primary transition-colors hover:scale-110 transform duration-300 flex items-center justify-center ${isYouTube ? 'w-14 h-14' : 'w-12 h-12'}`}
                  >
